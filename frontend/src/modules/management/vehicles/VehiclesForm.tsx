// src/modules/management/vehicles/VehicleForm.tsx
 ...
 * Actúa como una ventana modal que encapsula el formulario de captura de datos.
 */
export const VehicleForm: React.FC<VehicleFormProps> = ({
  ...
  // Desacoplamiento de la lógica de estado y validación mediante hook personalizado
  ...
  // Control de renderizado condicional para optimizar el DOM
  if (!isOpen) return null;

  return (
    // Overlay: Capa de fondo con desenfoque para focalizar la atención en el formulario
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        {/* Encabezado: Título dinámico basado en la existencia del objeto 'vehicle' */}
        ...
        {/* Formulario principal: Controla el flujo de envío de datos */}
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Acciones del formulario: Bloqueadas durante la sincronización asíncrona */}
